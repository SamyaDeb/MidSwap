...
export class Contract {
      ...
      initialize: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('initialize',
                                     ...
                                     'MidnightUSDC.compact line 24 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      mint: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('mint',
                                     'argument 1 (as invoked from Typescript)',
                                     'MidnightUSDC.compact line 32 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(to_0).concat(_descriptor_2.toValue(amount_0)),
      ...
      transfer: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('transfer',
                                     'argument 1 (as invoked from Typescript)',
                                     'MidnightUSDC.compact line 48 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      burn: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('burn',
                                     'argument 1 (as invoked from Typescript)',
                                     'MidnightUSDC.compact line 72 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      balanceOf: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('balanceOf',
                                     'argument 1 (as invoked from Typescript)',
                                     'MidnightUSDC.compact line 90 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._balanceOf_0(context, partialProofData, user_0);
        partialProofData.output = { value: _descriptor_2.toValue(result_0), alignment: _descriptor_2.alignment() };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      getTotalSupply: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getTotalSupply',
                                     'argument 1 (as invoked from Typescript)',
                                     'MidnightUSDC.compact line 97 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      isInitialized: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('isInitialized',
                                     'argument 1 (as invoked from Typescript)',
                                     'MidnightUSDC.compact line 102 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
  ...
  _mint_0(context, partialProofData, to_0, amount_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            'Not initialized');
    const toPub_0 = to_0;
    const amountPub_0 = amount_0;
    __compactRuntime.assert(amountPub_0 > 0n, 'Amount must be positive');
                                                                                          ...
                                                                                          path: [
                                                                                                 { tag: 'value',
                                                                                                   value: { value: _descriptor_6.toValue(1n),
                                                                                                            alignment: _descriptor_6.alignment() } }] } },
                                                                                 { push: { storage: false,
                                                                                           value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(toPub_0),
                      ...
                      _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                ...
                                                                                [
                                                                                 ...
                                                                                 { idx: { cached: false,
                                                                                          ...
                                                                                          path: [
                                                                                                 { tag: 'value',
                                                                                                   value: { value: _descriptor_1.toValue(toPub_0),
                                                                                                            alignment: _descriptor_1.alignment() } }] } },
                                                                                 { popeq: { cached: false,
                                                                                            result: undefined } }]).value)
                      :
    ...
    const newBalance_0 = ((t1) => {
                           if (t1 > 18446744073709551615n) {
                             throw new __compactRuntime.CompactError('MidnightUSDC.compact line 39 char 32: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                           }
                           return t1;
                         })(current_0 + amountPub_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('MidnightUSDC.compact line 42 char 26: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
  ...
  _transfer_0(context, partialProofData, sender_0, recipient_0, amount_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: false,
                                                                                                  result: undefined } }]).value),
                            'Not initialized');
    const senderPub_0 = sender_0;
    const recipientPub_0 = recipient_0;
    const amountPub_0 = amount_0;
    __compactRuntime.assert(amountPub_0 > 0n, 'Amount must be positive');
    const senderBalance_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                                                                                       { idx: { cached: false,
                                                                                       ...
                                                                                       { idx: { cached: false,
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_1.toValue(senderPub_0),
                                                                                                                  alignment: _descriptor_1.alignment() } }] } },
                                                                                       { popeq: { cached: false,
                                                                                                  result: undefined } }]).value);
    __compactRuntime.assert(senderBalance_0 >= amountPub_0,
                            'Insufficient balance');
    const recipientBalance_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                         partialProofData,
                                                                                         [
                                                                                          { dup: { n: 0 } },
                                                                                          { idx: { cached: false,
                                                                                                   ...
                                                                                                   path: [
                                                                                                          { tag: 'value',
                                                                                                            value: { value: _descriptor_6.toValue(1n),
                                                                                                                     alignment: _descriptor_6.alignment() } }] } },
                                                                                          { push: { storage: false,
                                                                                                    value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(recipientPub_0),
                                                                                                                                                 alignment: _descriptor_1.alignment() }).encode() } },
                                                                                          'member',
                                                                                          { popeq: { cached: true,
                                                                                                     result: undefined } }]).value)
                               ...
                               _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                         ...
                                                                                         [
                                                                                          ...
                                                                                          { idx: { cached: false,
                                                                                                   ...
                                                                                                   path: [
                                                                                                          { tag: 'value',
                                                                                                            value: { value: _descriptor_1.toValue(recipientPub_0),
                                                                                                                     alignment: _descriptor_1.alignment() } }] } },
                                                                                          { popeq: { cached: false,
                                                                                                     result: undefined } }]).value)
                               :
                               0n;
    const tmp_0 = (__compactRuntime.assert(senderBalance_0 >= amountPub_0,
                                           'result of subtraction would be negative'),
                   senderBalance_0 - amountPub_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                                ...
                                                path: [
                                                       { tag: 'value',
                                                         value: { value: _descriptor_6.toValue(1n),
                                                                  alignment: _descriptor_6.alignment() } }] } },
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(senderPub_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(tmp_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('MidnightUSDC.compact line 65 char 33: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(recipientBalance_0 + amountPub_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
    ...
    __compactRuntime.assert(senderBalance_0 >= amountPub_0,
                            'result of subtraction would be negative');
    return senderBalance_0 - amountPub_0;
  }
  _burn_0(context, partialProofData, owner_0, amount_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    const balance_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                ...
                                                                                [
                                                                                 ...
                                                                                 { idx: { cached: false,
                                                                                          ...
                                                                                          path: [
                                                                                                 { tag: 'value',
                                                                                                   value: { value: _descriptor_1.toValue(ownerPub_0),
                                                                                                            alignment: _descriptor_1.alignment() } }] } },
                                                                                 { popeq: { cached: false,
                                                                                            result: undefined } }]).value);
    __compactRuntime.assert(balance_0 >= amountPub_0, 'Insufficient balance');
    const newBalance_0 = (__compactRuntime.assert(balance_0 >= amountPub_0,
                                                  'result of subtraction would be negative'),
                          balance_0 - amountPub_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                                ...
                                                path: [
                                                       { tag: 'value',
                                                         value: { value: _descriptor_6.toValue(1n),
                                                                  alignment: _descriptor_6.alignment() } }] } },
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(ownerPub_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(newBalance_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
    ...
    const tmp_0 = (t_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                   ...
                                                                                   [
                                                                                    ...
                                                                                    { popeq: { cached: false,
                                                                                               result: undefined } }]).value),
                   (__compactRuntime.assert(t_0 >= amountPub_0,
                                            'result of subtraction would be negative'),
                    t_0 - amountPub_0));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _balanceOf_0(context, partialProofData, user_0) {
    const userPub_0 = user_0;
    const bal_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                            partialProofData,
                                                                            [
                                                                             { dup: { n: 0 } },
                                                                             { idx: { cached: false,
                                                                                      ...
                                                                                      path: [
                                                                                             { tag: 'value',
                                                                                               value: { value: _descriptor_6.toValue(1n),
                                                                                                        alignment: _descriptor_6.alignment() } }] } },
                                                                             { push: { storage: false,
                                                                                       value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(userPub_0),
                                                                                                                                    alignment: _descriptor_1.alignment() }).encode() } },
                                                                             'member',
                                                                             { popeq: { cached: true,
                                                                                        result: undefined } }]).value)
                  ...
                  _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                            ...
                                                                            [
                                                                             ...
                                                                             { idx: { cached: false,
                                                                                      ...
                                                                                      path: [
                                                                                             { tag: 'value',
                                                                                               value: { value: _descriptor_1.toValue(userPub_0),
                                                                                                        alignment: _descriptor_1.alignment() } }] } },
                                                                             { popeq: { cached: false,
                                                                                        result: undefined } }]).value)
                  :
